...
export async function runScraper(
  ...
  try {
    ...
    // Debug info
    if (result && typeof result === 'object' && 'debug' in result && result.debug) {
      // eslint-disable-next-line no-console
      console.log('Request URL:', result.debug.requestUrl);
      // eslint-disable-next-line no-console
      console.log('Request Headers:', result.debug.requestHeaders);
    }
  } catch (error) {
